...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined}: CampProps) => {
  return (
    <div className={`h-full w-ful min-w-[1100px] ${backgroundImage}
    ...
    lg:py-20 xl:mb-20'>
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        <CampSite 
          ...
          title="Maami Trip Camp"
          subtitle="Diego, San Paris"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
            <strong>Feeling Lost</strong> And Trying To Navigate Your Way
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Starting from the anxiety of the climbers when visiting a new climbing
            location, the possibilities of getting lost in the forest are very high. 
            That's why we are here for those of you who want to start the adventures.
          </p>
          <Image 
            src='/quote.svg'
            alt='camp-2'
